...
options=("ALEX" "Roaring" "EliasFano" "GammaCode16" "GammaCode32" "DeltaCode16" "DeltaCode32" "LA-vector6" "LA-vector8" "LA-vector10" "LA-vector12" "CSS-BTree" "PLEX8" "PLEX32" "PLEX128" "PGM8" "PGM32" "PGM128" "PGM++8" "PGM++32" "PGM++128" "std::vector" "SIMD-BTree" "SIMD-SampledBTree")
