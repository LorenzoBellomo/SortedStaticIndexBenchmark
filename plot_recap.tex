...
\vspace*{-0.40cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/no_label}
        \end{figure}
    \end{minipage}
    \vspace*{-18px}
...
\vspace*{-0.4cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/64_no_label}
        \end{figure}
    \end{minipage}
    \vspace*{-18px}
...
\vspace*{-0.2cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/index}
        \end{figure}
    \end{minipage}
    \vspace*{-10px}
...
\vspace*{-0.2cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/index64}
        \end{figure}
    \end{minipage}
    \vspace*{-10px}
...
\vspace*{-0.2cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/vec}
        \end{figure}
    \end{minipage}
...
\vspace*{-0.2cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/vec64}
        \end{figure}
    \end{minipage}
    \vspace*{-10px}
...
\vspace*{-0.7cm}
   ...
   \begin{minipage}{0.75\linewidth}
        \begin{figure}[H]
        \includegraphics[width=\linewidth]{legends/scan}
        \end{figure}
    \end{minipage}
    \vspace*{-20px} 
...
% PARETO standard and learned indexes
\begin{figure}[!htbp]
\fbox
{
\begin{minipage}[t][0.98\textheight][t]{\textwidth}
...
\begin{table}[t]
\input{plots/tables/companynet_uint32}
\caption{Tabular data: companynet dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/wiki_ts_200M_uint32}
\caption{Tabular data: wiki uint32 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/friendster_50M_uint32}
\caption{Tabular data: friendster dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/exponential_uint32}
\caption{Tabular data: exponential dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/lognormal_uint32}
\caption{Tabular data: lognormal dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/zipf_uint32}
\caption{Tabular data: zipf dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/normal_uint32}
\caption{Tabular data: normal dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/books_200M_uint32}
\caption{Tabular data: amzn uint32 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/books_800M_uint64}
\caption{Tabular data: amzn uint64 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/osm_cellids_800M_uint64}
\caption{Tabular data: OSM cellids dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/wiki_ts_200M_uint64}
\caption{Tabular data: wiki uint64 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/fb_200M_uint64}
\caption{Tabular data: FB uint64 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/scan_companynet_uint32}
\caption{Tabular data: SCAN experiments on the companynet dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/scan_wiki_ts_200M_uint32}
\caption{Tabular data: SCAN experiments on the wiki uint32 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/scan_books_200M_uint32}
\caption{Tabular data: SCAN experiments on the amzn uint32 dataset}
\end{table}

\begin{table}[t]
\input{plots/tables/scan_fb_200M_uint64}
\caption{Tabular data: SCAN experiments on the FB uint64 dataset}
\end{table}
