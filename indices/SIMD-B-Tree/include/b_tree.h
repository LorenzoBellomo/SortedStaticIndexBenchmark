...
namespace SIMD_Btree {
    ...
    public:
        ...
        value_type operator[](const size_t idx) const {
            ...
            size_t fanout_prev = 1;
            size_t depth = log_tree_size - 1;

            while (adjusted_idx % fanout_power == 0 && depth > 0) {
                fanout_prev = fanout_power;
             ...
             */
            size_t offset = adjusted_idx / fanout_prev - adjusted_idx / fanout_power - 1;
